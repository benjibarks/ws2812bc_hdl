# ws2812bc_hdl
WS2812B/C driver implemented in HDL for FPGA. User interfaces implemented include:
...
## Usage
Source the desired HDL files from the `hdl` directory. Dependency trees are documented in the readme in that directory.
